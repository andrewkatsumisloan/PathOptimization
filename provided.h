...
struct GeoCoord
{
    // GeoCoord is initialized with the latituded and longitude values as strings,
...
{
    // StreetSegment holds the starting/ending GeoCoord for the Street, and the name of that Street
